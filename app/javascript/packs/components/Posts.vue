  ...
  <b-container>
    <div class="app-header">
      <div class="relative-search">
        ...
        <input placeholder="Search for..." v-model='terms' name="search_query" type="text" v-on:keyup.enter="getPosts(page)" class="form-control input-focus all-animate w-100 bg-white db shadow-inset-2 ba bw1 br2 pv3 pl4 pr6 lh-solid sans-serif b--gray3 fw6 f5 gray7"> <!----> 
